...
```typescript
defHttp.post({ url: Api.Login, params, headers: { 'Content-Type': ContentTypeEnum.FORM_URLENCODED } });
...
requestClient.post(Api.Login, params, { headers: { 'Content-Type': 'application/x-www-form-urlencoded' } });
