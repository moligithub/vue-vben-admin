  ...
  children: [
    {
      ...
      meta: {
        ...
        defaultTitle: '首页',
        icon: 'icon-bts icon-bts-nav-home',
        affix: true,
      },
    },
    {
      ...
      meta: {
        ...
        defaultTitle: '站内消息',
        icon: 'icon-bts icon-bts-sysNotice',
      },
    },
    {
      path: '/profile',
    ...
    },
    {
      ...
      meta: {
        ...
        defaultTitle: '链接',
        icon: 'icon-bts icon-bts-generator-link',
      },
    },
    {
      path: '/workFlowDetail',
      component: () => import('/@/views/businessflow/workFlowDetail/index.vue'),
      name: 'workFlowDetail',
      meta: {
        title: 'routes.basic.workFlowDetail',
        defaultTitle: '流程详情',
        icon: 'icon-bts icon-bts-workFlow',
      },
    },
    {
      path: '/emailDetail',
      ...
      meta: {
        ...
        defaultTitle: '查看邮件',
        icon: 'icon-bts icon-bts-emailExample',
      },
    },
    {
      path: '/previewModel',
      ...
      meta: {
        ...
        defaultTitle: '功能预览',
        icon: 'icon-bts icon-bts-btn-preview',
      },
    },
  ],
};
