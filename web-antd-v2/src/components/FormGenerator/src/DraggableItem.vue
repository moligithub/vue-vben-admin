    ...
    setup(props, { attrs }) {
        ...
        tableSetting(element) {
          ...
          return [
            <span
              ...
              <i class="icon-bts icon-bts-generator-insertRow" />
            </span>,
            <span
              ...
              <i class="icon-bts icon-bts-generator-insertCol" />
            </span>,
          ];
        },
          ...
          return [
            <span class="drawing-item-cell">
              <a-dropdown
                ...
                <i class="icon-bts icon-bts-generator-TableSettings" />
              </a-dropdown>
            </span>,
          ];
        },
      ...
      const layouts = {
        colFormItem(element, index, parent) {
          ...
          if (config.tsaDK == 'location') element.useAutoLocation = false;
          const Item =
            props.showType === 'app' && !useCompList.includes(config.tsaDK) ? (
        ...
        rowFormItem(element, index, parent) {
          ...
          if (element.__config__.tsaDK === 'tableGrid') {
          ...
          if (config.tsaDK === 'row' || (props.showType === 'app' && config.tsaDK === 'card')) {
            return (
              <a-col
                span={props.showType === 'app' ? 24 : config.span}
                data-draggable={true}
                ...
                <a-row class={className + ' drawing-row-item-row'}>
                  <span class="component-name">{config.tsaDK === 'card' ? config.label : config.componentName}</span>
                  <a-col>
