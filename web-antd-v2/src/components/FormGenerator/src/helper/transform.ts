...
export const getRealProps = (data, tsaDK) => {
...
export const getFormSchemaItem = data => {
  const item = getRealProps(data, data.__config__.tsaDK);
  ...
  const schema = {
    ...
    component: upperFirst(item.__config__.tsaDK),
    componentProps,
