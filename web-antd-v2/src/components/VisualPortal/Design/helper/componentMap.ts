const dataBoardDefault = [
  {
    ...
    num: 262,
    field: '',
    icon: 'icon-bts icon-bts-wf-contractApproval',
  ...
  },
  {
    ...
    num: 199,
    field: '',
    icon: 'icon-bts icon-bts-wf-outgoingApply',
  ...
  },
  {
    ...
    num: 126263.5,
    field: '',
    icon: 'icon-bts icon-bts-wf-payDistribution',
  ...
  },
  {
    ...
    num: 6223.2,
    field: '',
    icon: 'icon-bts icon-bts-wf-incomeRecognition',
...
export const layoutComponents = [
  {
    icon: 'icon-bts icon-bts-portal-card',
    label: '卡片面板',
    tsaDK: 'card',
    title: '卡片面板',
    visibility: ['pc', 'app'],
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-bts icon-bts-portal-card',
  ...
  {
    icon: 'icon-bts icon-bts-portal-tab',
    label: '标签面板',
    tsaDK: 'tab',
    title: '标签面板',
    visibility: ['pc', 'app'],
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-bts icon-bts-portal-tab',
      cardIconColor: '#606266',
      linkType: '',
      type: '',
      moduleId: '',
...
export const systemComponents = [
  {
    icon: 'icon-bts icon-bts-generator-notice',
    label: '公告通知',
    tsaDK: 'notice',
    title: '公告通知',
    renderKey: '',
    ...
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-bts icon-bts-generator-notice',
      cardIconColor: '#606266',
      linkType: '',
      type: '',
      moduleId: '',
  ...
  // {
  //   icon: 'icon-bts icon-bts-generator-email',
  //   label: '未读邮件',
  //   tsaDK: 'email',
  //   title: '未读邮件',
  //   visibility: ['pc', 'app'],
  ...
  //     titleLeft: 'left',
  //     titleBgColor: '',
  //     cardIcon: 'icon-bts icon-bts-generator-email',
  //     cardIconColor: '#606266',
  //     linkType: '',
  //     type: '',
  //     moduleId: '',
  ...
  // },
  {
    icon: 'icon-bts icon-bts-generator-todolist',
    label: '待办事项',
    tsaDK: 'todoList',
    title: '待办事项',
    visibility: ['pc', 'app'],
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-bts icon-bts-generator-todolist',
      cardIconColor: '#606266',
      linkType: '',
      type: '',
      moduleId: '',
...
export const basicComponents = [
  {
    icon: 'icon-bts icon-bts-generator-todo',
    label: '我的待办',
    tsaDK: 'todo',
    title: '我的待办',
    renderKey: '',
    ...
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-bts icon-bts-generator-todo',
      cardIconColor: '#606266',
      linkType: '',
      type: '',
      moduleId: '',
      ...
      defaultValue: [
        {
          ...
          icon: 'icon-bts icon-bts-flowTodo',
          iconBgColor: '#f68900',
          type: 2,
        },
        {
          ...
          icon: 'icon-bts icon-bts-flowDone',
          iconBgColor: '#7b1ae1',
          type: 2,
        },
        {
          ...
          icon: 'icon-bts icon-bts-flowForm',
          iconBgColor: '#33b932',
          type: 2,
        },
      ],
  ...
  {
    icon: 'icon-bts icon-bts-generator-function',
    label: '常用功能',
    tsaDK: 'commonFunc',
    title: '常用功能',
    renderKey: '',
    ...
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-bts icon-bts-generator-function',
      cardIconColor: '#606266',
      linkType: '',
      type: '',
      moduleId: '',
      ...
      defaultValue: [
        {
          ...
          icon: 'icon-bts icon-bts-webDesign',
          iconBgColor: '#FF3B3B',
          type: 2,
          id: '1',
        },
        {
          ...
          icon: 'icon-bts icon-bts-flowDesign',
          iconBgColor: '#7B1AE1',
          type: 2,
          id: '2',
        },
        {
          ...
          icon: 'icon-bts icon-bts-authorize',
          iconBgColor: '#1890FF',
          type: 2,
          id: '3',
        },
        {
          ...
          icon: 'icon-bts icon-bts-reportDesign',
          iconBgColor: '#F68900',
          type: 2,
          id: '4',
        },
        {
          ...
          icon: 'icon-bts icon-bts-portalDesign',
          iconBgColor: '#33B932',
          type: 2,
          id: '5',
        },
      ...
      appDefaultValue: [
        {
          ...
          moduleId: '',
          linkType: '2',
          urlAddress: 'https://www.bstsoftTTT.com/',
          linkTarget: '_blank',
          icon: 'icon-bts icon-bts-webDesign',
          iconBgColor: '#33B932',
          type: 2,
  ...
  {
    icon: 'icon-bts icon-bts-generator-Panel',
    label: '数据面板',
    tsaDK: 'dataBoard',
    title: '数据面板',
    dataType: 'static',
  ...
  {
    icon: 'icon-bts icon-bts-generator-table',
    label: '表格列表',
    tsaDK: 'tableList',
    title: '表格列表',
    dataType: 'static',
    ...
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-bts icon-bts-generator-table',
      cardIconColor: '#606266',
      linkType: '',
      type: '',
      moduleId: '',
  ...
  {
    icon: 'icon-bts icon-bts-generator-textarea',
    label: '文本',
    tsaDK: 'text',
    title: '文本',
    renderKey: '',
    ...
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-bts icon-bts-generator-textarea',
      cardIconColor: '#606266',
      linkType: '',
      type: '',
      moduleId: '',
  ...
  {
    icon: 'icon-bts icon-bts-portal-image',
    label: '图片',
    tsaDK: 'image',
    title: '图片',
    renderKey: '',
    ...
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-bts icon-bts-portal-image',
      cardIconColor: '#606266',
      linkType: '',
      type: '',
      moduleId: '',
  ...
  {
    icon: 'icon-bts icon-bts-portal-carousel',
    label: '轮播图',
    tsaDK: 'carousel',
    title: '轮播图',
    renderKey: '',
    ...
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-bts icon-bts-portal-carousel',
      cardIconColor: '#606266',
      linkType: '',
      type: '',
      moduleId: '',
    ...
    option: {
      ...
      defaultValue: [
        {
          // imageUrl: 'https://app.cdn.bstsoftTTT.com/image/3.2/banner1.png',
          imageUrl: './resource/img/banner1.png',
          dataType: 2,
          propsApi: '',
          moduleId: '',
          linkType: '',
        ...
        {
          // imageUrl: 'https://app.cdn.bstsoftTTT.com/image/3.2/banner2.png',
          imageUrl: './resource/img/banner2.png',
          dataType: 2,
          propsApi: '',
          moduleId: '',
          linkType: '',
        ...
        {
          // imageUrl: 'https://app.cdn.bstsoftTTT.com/image/3.2/banner4.png',
          imageUrl: './resource/img/banner4.png',
          dataType: 2,
          propsApi: '',
          moduleId: '',
          linkType: '',
  ...
  {
    icon: 'icon-bts icon-bts-portal-video',
    label: '视频',
    tsaDK: 'video',
    title: '视频',
    renderKey: '',
    ...
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-bts icon-bts-portal-video',
      cardIconColor: '#606266',
      linkType: '',
      type: '',
      moduleId: '',
  ...
  {
    icon: 'icon-bts icon-bts-portal-schedule',
    label: '日程',
    tsaDK: 'schedule',
    title: '日程',
    renderKey: '',
    ...
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-bts icon-bts-portal-schedule',
      cardIconColor: '#606266',
      linkType: '',
      type: '',
      moduleId: '',
  ...
  {
    icon: 'icon-bts icon-bts-portal-iframe',
    label: 'Iframe',
    tsaDK: 'iframe',
    title: 'Iframe',
    visibility: ['pc'],
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-bts icon-bts-portal-iframe',
      cardIconColor: '#606266',
      linkType: '',
      type: '',
      moduleId: '',
    ...
    option: {
      defaultValue: 'https://www.bstsoftTTT.com/',
    },
    w: 12,
    h: 8,
    minW: 4,
...
export const chartComponents = [
  {
    icon: 'icon-bts icon-bts-generator-bar',
    label: '柱状图',
    tsaDK: 'barChart',
    title: '柱状图',
    renderKey: '',
    ...
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-bts icon-bts-generator-bar',
      cardIconColor: '#606266',
      linkType: '',
      type: '',
      moduleId: '',
  ...
  {
    icon: 'icon-bts icon-bts-generator-pie',
    label: '饼图',
    tsaDK: 'pieChart',
    title: '饼图',
    renderKey: '',
    ...
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-bts icon-bts-generator-pie',
      cardIconColor: '#606266',
      linkType: '',
      type: '',
      moduleId: '',
  ...
  {
    icon: 'icon-bts icon-bts-generator-line',
    label: '折线图',
    tsaDK: 'lineChart',
    title: '折线图',
    renderKey: '',
    ...
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-bts icon-bts-generator-line',
      cardIconColor: '#606266',
      linkType: '',
      type: '',
      moduleId: '',
  ...
  {
    icon: 'icon-bts icon-bts-generator-radar', //'icon-bts icon-bts-generator-annular',
    label: '雷达图',
    tsaDK: 'radarChart',
    title: '雷达图',
    renderKey: '',
    ...
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-bts icon-bts-generator-radar',
      cardIconColor: '#606266',
      linkType: '',
      type: '',
      moduleId: '',
  ...
  {
    icon: 'icon-bts icon-bts-generator-area',
    label: '地图',
    tsaDK: 'mapChart',
    title: '地图',
    renderKey: '',
    ...
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-bts icon-bts-generator-area',
      cardIconColor: '#606266',
      linkType: '',
      type: '',
      moduleId: '',
  ...
  {
    icon: 'icon-bts icon-bts-portal-rankList',
    label: '排行榜',
    tsaDK: 'rankList',
    title: '排行榜',
    renderKey: '',
    ...
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-bts icon-bts-portal-rankList',
      cardIconColor: '#606266',
      linkType: '',
      type: '',
      moduleId: '',
  ...
  {
    icon: 'icon-bts icon-bts-portal-timeAxis',
    label: '时间轴',
    tsaDK: 'timeAxis',
    title: '时间轴',
    renderKey: '',
    ...
    card: {
      ...
      titleLeft: 'left',
      titleBgColor: '',
      cardIcon: 'icon-bts icon-bts-portal-timeAxis',
      cardIconColor: '#606266',
      linkType: '',
      type: '',
      moduleId: '',
