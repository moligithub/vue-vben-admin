...
<script lang="ts" setup>
  ...
  defineOptions({ name: 'TsaCheckbox', inheritAttrs: false });
  ...
  const getBindValue = computed(() => ({
    ...unref(attrs),
    class: unref(attrs).class ? `tsa-${props.direction}-checkbox ${unref(attrs).class}` : `tsa-${props.direction}-checkbox`,
  }));
