...
<script lang="ts" setup>
  import { getOrganizeSelectorByAuth, getDepartmentSelectorByAuth, getOrgByOrganizeCondition } from '/@/api/permissionmgr/organize';
  ...
  defineOptions({ name: 'TsaOrganizeSelect', inheritAttrs: false });
  ...
  async function initData() {
    ...
    const topItem = {
      ...
      hasChildren: true,
      id: '-1',
      icon: 'icon-bts icon-bts-tree-organization3',
      organize: '顶级节点',
      organizeIds: ['-1'],
    };
