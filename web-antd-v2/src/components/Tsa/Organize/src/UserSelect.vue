...
<script lang="ts" setup>
  import { getImUserSelector, getUserInfoList, getSubordinates, getOrganization, getSelectedUserList } from '/@/api/permissionmgr/user';
  ...
  defineOptions({ name: 'TsaUserSelect', inheritAttrs: false });
  ...
  const sysUserList = ref<any[]>([
    {
      id: 'currentUser',
      fullName: '当前用户',
      headIcon: '/bot/filehandler/Image/userAvatar/001.png',
    },
  ]);
