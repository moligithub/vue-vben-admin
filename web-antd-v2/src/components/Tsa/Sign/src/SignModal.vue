<template>
  <a-modal v-model:visible="visible" title="请签名" class="tsa-sign-modal" centered :maskClosable="false" :keyboard="false" :width="600">
    <template #closeIcon>
...
<script lang="ts" setup>
  import { createSign } from '/@/api/permissionmgr/userSetting';
