...
const url = isDevMode()
  ? globSetting.webSocketUrl + '/bot/imcenter/websocket/'
...
export function useWebSocket() {
  ...
  function initWebSocket() {
    ...
    function onOpen() {
      const onConnection = { method: 'OnConnection', mobileDevice: false, systemId: userInfo.systemId, isSeparate: !!getTsaAppId() };
