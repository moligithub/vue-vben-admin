...
<script lang="ts" setup>
  import { createModel, updateModel, getModelInfo } from '/@/api/lowcodedev/visualDev';
  ...
  import { getDateTimeUnit } from '/@/utils/tsa';
  ...
  function init(data) {
    ...
    state.title = !data.id || data.id === 'tsaAdd' ? '新增' : '编辑';
    ...
    state.dataForm.id = !data.id || data.id === 'tsaAdd' ? '' : data.id;
    getFormOperates();
    openForm();
