    ...
    <template v-if="!expand">
      <tr v-for="(item, index) in fewData" class="child-table__row" :key="index">
        <td
          ...
          <div class="cell" v-if="headItem.tsaDK === 'relationForm'">
          ...
          <div class="cell" v-else-if="headItem.tsaDK === 'inputNumber'">
            <tsa-input-number v-model:value="item[headItem.dataIndex]" :precision="headItem.precision" :thousands="headItem.thousands" disabled detailed />
          </div>
          <div class="cell" v-else-if="headItem.tsaDK === 'calculate'">
            <tsa-calculate
          ...
          <div class="cell" v-else-if="headItem.tsaDK === 'sign'">
            <tsa-sign v-model:value="item[headItem.dataIndex]" detailed />
          </div>
          <div class="cell" v-else-if="headItem.tsaDK === 'signature'">
            <tsa-signature v-model:value="item[headItem.dataIndex]" detailed />
          </div>
          <div class="cell" v-else-if="headItem.tsaDK === 'rate'">
            <tsa-rate v-model:value="item[headItem.dataIndex]" :count="headItem.count" :allowHalf="headItem.allowHalf" disabled />
          </div>
          <div class="cell" v-else-if="headItem.tsaDK === 'slider'">
            <tsa-slider v-model:value="item[headItem.dataIndex]" :min="headItem.min" :max="headItem.max" :step="headItem.step" disabled />
          </div>
          <div class="cell" v-else-if="headItem.tsaDK === 'uploadImg'">
            <tsa-upload-img v-model:value="item[headItem.dataIndex]" disabled detailed simple v-if="item[headItem.dataIndex]?.length" />
          </div>
          <div class="cell" v-else-if="headItem.tsaDK === 'uploadFile'">
            <tsa-upload-file v-model:value="item[headItem.dataIndex]" disabled detailed simple v-if="item[headItem.dataIndex]?.length" />
          </div>
          <div class="cell" v-else-if="headItem.tsaDK === 'input'">
            <tsa-input
              v-model:value="item[headItem.dataIndex]"
