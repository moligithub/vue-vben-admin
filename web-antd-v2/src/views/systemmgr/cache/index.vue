    ...
    <div class="tsa-content-wrapper-center">
      <div class="tsa-content-wrapper-content">
        <BasicTable @register="registerTable">
          <template #tableTitle>
            <a-button type="error" preIcon="icon-bts icon-bts-btn-clearn" @click="handleDelAllCache()">清空所有</a-button>
          </template>
...
<script lang="ts" setup>
  ...
  import { getCacheList, delCache, delAllCache } from '/@/api/systemmgr/cache';
