<template>
  <div class="tsa-content-wrapper">
    <div class="tsa-content-wrapper-center bg-white">
      <a-form :colon="false" labelAlign="right" :labelCol="{ style: { width: '100px' } }" class="right-board-form h-full">
        <a-tabs class="tsa-content-wrapper-tabs" v-model:activeKey="activeKey" type="card">
          <a-tab-pane :key="1" tab="基本设置" class="p-30px">
            <a-row>
              <a-col :span="24">
                <a-form-item label="系统图标">
                  <div class="img-list">
                    <TsaUploadImgSingle v-model:value="baseForm.loginIcon" tipText="登录图标" />
                    <TsaUploadImgSingle v-model:value="baseForm.logoIcon" tipText="LOGO图标" />
                    <TsaUploadImgSingle v-model:value="baseForm.appIcon" tipText="APP图标" />
                  </div>
                </a-form-item>
              </a-col>
              <a-col :span="24">
            ...
            <a-tabs v-model:activeKey="thirdTab" tab-position="left" style="height: 100%">
              <a-tab-pane :key="1" tab="登录策略">
                <a-row>
                  <a-col :span="8">
                    <a-form-item label="登录方式">
                      <tsa-select v-model:value="baseForm.singleLogin" placeholder="请选择" :options="singleLoginOptions" />
                    </a-form-item>
                ...
                <a-row class="mt-10px">
                  <a-col :span="10">
                    <a-form-item label=" ">
                      <tsa-radio v-model:value="baseForm.lockType" :options="lockTypeOptions" />
                      <div class="mt-10px">
                ...
                <a-row>
                  <a-col :span="8">
                    <a-form-item label="登录验证码">
                      <tsa-switch v-model:value="baseForm.enableVerificationCode" />
                    </a-form-item>
                    ...
                    <a-form-item label="登录提示语">
                      <tsa-switch v-model:value="baseForm.lastLoginTimeSwitch" />
                    </a-form-item>
                    <a-form-item v-if="baseForm.lastLoginTimeSwitch" label=" ">
                      <a-card size="small" style="width: 300px" :body-style="{ padding: '0px 20px' }">
                        ...
                        <template #extra>
                          <i class="icon-bts icon-bts-nav-close card-extra" />
                        </template>
                        <div class="card-item">
                    ...
                    <a-form-item label="白名单验证">
                      <tsa-switch v-model:value="baseForm.whitelistSwitch" />
                    </a-form-item>
                  </a-col>
                </a-row>
                <a-row>
                ...
                <a-row>
                  <a-col :span="8">
                    <a-form-item label="密码定期更新" :labelCol="{ style: { width: '120px' } }">
                      <tsa-switch v-model:value="baseForm.passwordIsUpdatedRegularly" />
                    </a-form-item>
                    ...
                    <a-form-item label="密码强度限制" :labelCol="{ style: { width: '120px' } }">
                      <tsa-switch v-model:value="baseForm.passwordStrengthLimit" />
                    </a-form-item>
                  </a-col>
                </a-row>
                <a-row>
                  <a-col :span="10">
                    <a-form-item label=" " v-if="baseForm.passwordStrengthLimit" :labelCol="{ style: { width: '120px' } }">
                      <div class="flex">
                        <TsaCheckboxSingle class="checkbox mr-20px" label="最小长度" v-model:value="baseForm.passwordLengthMin" />
                        <a-input-number
                      ...
                      <TsaCheckboxSingle class="checkbox" label="包含数字" v-model:value="baseForm.containsNumbers" /><br />
                      <TsaCheckboxSingle class="checkbox" label="包含小写字母" v-model:value="baseForm.includeLowercaseLetters" /><br />
                      <TsaCheckboxSingle class="checkbox" label="包含大写字母" v-model:value="baseForm.includeUppercaseLetters" /><br />
                      <TsaCheckboxSingle class="checkbox" label="包含字符" v-model:value="baseForm.containsCharacters" />
                    </a-form-item>
                  </a-col>
                </a-row>
                <a-row>
                  <a-col :span="8">
                    <a-form-item label="禁用旧密码" :labelCol="{ style: { width: '120px' } }">
                      <tsa-switch v-model:value="baseForm.disableOldPassword" />
                    </a-form-item>
                    ...
                    <a-form-item label="修改初始密码提醒" :labelCol="{ style: { width: '120px' } }">
                      <tsa-switch v-model:value="baseForm.mandatoryModificationOfInitialPassword" />
                    </a-form-item>
            ...
            <a-row>
              <a-col :span="12">
                <a-form-item label="超级管理员">
                  <tsa-user-select v-model:value="adminIds" placeholder="请选择" multiple />
                </a-form-item>
                <a-form-item label=" ">
            ...
            <a-row>
              <a-col :span="8">
                ...
                <a-form-item :labelCol="{ style: { width: '120px' } }">
                  ...
                  <tsa-switch v-model:value="baseForm.isClick" />
                </a-form-item>
    ...
    <BasicModal v-bind="$attrs" @register="registerModal" title="数据同步" :footer="null" :width="450" class="sync-dialog">
      <div class="add-item">
        <i class="add-icon syn-icon icon-bts icon-bts-upload"></i>
        <div class="add-txt">
      ...
      <div class="add-item ding-item">
        <i class="add-icons syn-icon icon-bts icon-bts-download"></i>
        <div class="add-txt">
