      ...
      <div class="tsa-content-wrapper-content">
        <BasicTable @register="registerTable">
          <template #tableTitle>
            ...
            <tsa-upload-btn url="/bot/systemmgr/BillRule/Actions/Import" accept=".bb" @on-success="reload"></tsa-upload-btn>
          </template>
...
<script lang="ts" setup>
  ...
  import { getBillRuleList, delBillRule, exportTpl } from '/@/api/systemmgr/billRule';
