      ...
      <div class="tsa-content-wrapper-content">
        <BasicTable @register="registerTable">
          <template #tableTitle>
            ...
            <tsa-upload-btn url="/bot/systemmgr/printDev/Actions/Import" accept=".bp" @on-success="reload"></tsa-upload-btn>
          </template>
...
<script lang="ts" setup>
  ...
  import { getPrintDevList, delPrintDev, copy, exportData } from '/@/api/systemmgr/printDev';
