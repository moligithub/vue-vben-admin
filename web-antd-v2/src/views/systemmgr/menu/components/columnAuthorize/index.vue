  ...
  <BasicDrawer v-bind="$attrs" @register="registerDrawer" :title="title" :width="700" class="full-drawer">
    <BasicTable @register="registerTable">
      <template #tableTitle>
        ...
        <a-button type="link" preIcon="bts-custom bts-custom-content-copy" @click="handleBatchAdd">批量新增</a-button>
...
<script lang="ts" setup>
  import { getColumnAuthorizeList, del } from '/@/api/systemmgr/columnAuthorize';
