    ...
    <BasicTable @register="registerTable">
      <template #tableTitle>
        ...
        <a-dropdown>
          ...
          <a-button type="link" :loading="loading" preIcon="icon-bts icon-bts-btn-add">常用按钮权限<DownOutlined /></a-button>
        </a-dropdown>
      </template>
...
<script lang="ts" setup>
  import { getButtonAuthorizeList, del, create } from '/@/api/systemmgr/buttonAuthorize';
