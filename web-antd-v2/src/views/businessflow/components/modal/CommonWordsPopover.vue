<template>
  <a-popover placement="bottom" trigger="manual" overlayClassName="commonWords-popover" v-model:visible="popoverVisible">
    <a-button type="link" preIcon="icon-bts icon-bts-btn-add" class="!px-0" @click="openPopover">常用语</a-button>
    <template #content>
...
<script lang="ts" setup>
  import { getCommonWordsSelector, delCommonWords } from '/@/api/systemmgr/commonWords';
  import { reactive, toRefs } from 'vue';
  import { useMessage } from '/@/hooks/web/useMessage';
  import { useI18n } from '/@/hooks/web/useI18n';
  import { useModal } from '/@/components/Modal';
  import Form from '/@/views/systemmgr/commonWords/Form.vue';
