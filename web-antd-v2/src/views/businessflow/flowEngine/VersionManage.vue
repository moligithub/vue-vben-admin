<template>
  <BasicPopup v-bind="$attrs" @register="registerPopup" :title="getTitle" class="full-popup" :closeFunc="onClose">
    <BasicTable :columns="columns" @register="registerTable" class="tsa-sub-table tsa-sub-table-full" v-show="!showFlow">
...
<script lang="ts" setup>
  import { getFlowJsonList, setMainVersion, delVersion, getFlowList } from '/@/api/businessflow/flowEngine';
