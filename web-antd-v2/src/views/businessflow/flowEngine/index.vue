      ...
      <div class="tsa-content-wrapper-content">
        <BasicTable @register="registerTable">
          <template #tableTitle>
            ...
            <tsa-upload-btn url="/bot/businessflow/Engine/flowTemplate/Actions/Import" accept=".ffe" @on-success="reload"></tsa-upload-btn>
          </template>
...
<script lang="ts" setup>
  ...
  import { getFlowEngineList, delFlowEngine, copy, exportData, release, stop } from '/@/api/businessflow/flowEngine';
