      ...
      <div class="tsa-content-wrapper-content">
        <BasicTable @register="registerTable">
          <template #tableTitle>
            ...
            <tsa-upload-btn url="/bot/businessform/Form/Actions/Import" accept=".fff" @on-success="reload"></tsa-upload-btn>
          </template>
...
<script lang="ts" setup>
  import { ref } from 'vue';
  import { getFormList, delForm, copy, exportData, release } from '/@/api/businessflow/formDesign';
