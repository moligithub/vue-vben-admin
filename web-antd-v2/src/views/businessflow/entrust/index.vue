  ...
  <div class="tsa-content-wrapper">
    <div class="tsa-content-wrapper-center">
      ...
      <div class="tsa-content-wrapper-content bg-white">
        <a-tabs v-model:activeKey="activeKey" type="card" class="tsa-content-wrapper-tabs" destroyInactiveTabPane @tabClick="onTabClick">
          <a-tab-pane key="0" tab="委托发起">
            <BasicTable @register="registerLaunchTable" :searchInfo="getSearchInfo">
              <template #tableTitle>
                <a-button type="primary" preIcon="icon-bts icon-bts-btn-add" @click="openAddModal()">发起委托</a-button>
              </template>
...
<script lang="ts" setup>
  ...
  import { getFlowLaunchList, delFlowLaunch } from '/@/api/businessflow/flowLaunch';
  import { getFlowDelegateList, delFlowDelegate, stop } from '/@/api/businessflow/flowDelegate';
