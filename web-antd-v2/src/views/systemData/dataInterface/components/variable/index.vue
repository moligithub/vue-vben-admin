<template>
  <BasicPopup v-bind="$attrs" @register="registerPopup" title="提取变量" class="full-popup">
    <div class="tsa-content-wrapper-search-box pl-10px mt-10px">
    ...
    <BasicTable @register="registerTable" :columns="menuTableColumns" :searchInfo="getSearchInfo">
      <template #tableTitle>
        ...
        <tsa-upload-btn url="/bot/systemmgr/DataInterfaceVariate/Actions/Import" accept=".ffa" @on-success="reload"></tsa-upload-btn>
      </template>
...
<style lang="less" scoped>
  .tsa-content-wrapper-search-box {
