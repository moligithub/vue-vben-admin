    ...
    <template v-if="!noData">
      <template v-if="!ajaxing">
        ...
        <div class="portal-layout-nodata" v-else>
          <tsa-empty :image="emptyImage" />
        </div>
      </template>
      <Setting @register="registerSettingDrawer" @refresh="refresh" />
      <a-button type="primary" preIcon="icon-bts icon-bts-left" class="setting-btn" size="large" @click="openSettingDrawer(true, { id: portalId })"></a-button>
    </template>
    <template v-else>
