<template>
  <div class="password">
    <tsa-group-title content="修改密码" class="mb-20px" />
    <a-row>
      <a-col :span="12">
...
<script lang="ts" setup>
  ...
  import { getSysConfig } from '/@/api/systemmgr/sysConfig';
  import { updatePassword } from '/@/api/permissionmgr/userSetting';
  ...
  function initCodeImg() {
    ...
    state.codeImg = `/bot/filehandler/ImageCode/${state.timestamp}`;
  }
  function resetForm() {
    state.dataForm = {
      oldPassword: '',
