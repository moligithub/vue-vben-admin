<template>
  <div class="tsa-content-wrapper bg-white sysLog">
...
<script lang="ts" setup>
  ...
  import { getLogList } from '/@/api/permissionmgr/userSetting';
  import { delLog, batchDelLoginLog } from '/@/api/systemmgr/log';
