...
<script lang="ts" setup>
  import { getAuthorizeValues, updateAuthorizeList, updateBatchAuthorize } from '/@/api/permissionmgr/authorize';
  import { getRoleSelectorByPermission } from '/@/api/permissionmgr/role';
