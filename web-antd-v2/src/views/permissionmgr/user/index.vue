<template>
  <div class="tsa-content-wrapper">
    <div class="tsa-content-wrapper-left">
      <BasicLeftTree
        title="组织机构"
        :treeData="treeData"
        :loading="treeLoading"
      ...
      <div class="tsa-content-wrapper-content">
        <BasicTable @register="registerTable" :searchInfo="searchInfo" ref="tableRef">
          <template #tableTitle>
            ...
            <a-button type="link" @click="handleExport"><i class="icon-bts icon-bts-btn-download button-preIcon"></i>{{ t('common.exportText') }}</a-button>
            <a-button type="link" @click="handleImport"><i class="icon-bts icon-bts-btn-upload button-preIcon"></i>{{ t('common.importText') }}</a-button>
            <a-button type="link" @click="handleSync"><i class="icon-bts icon-bts-synForThird button-preIcon"></i>{{ t('common.syncText') }}</a-button>
          </template>
...
<script lang="ts" setup>
  ...
  import { getUserList, unlockUser, delUser } from '/@/api/permissionmgr/user';
  import { getDepartmentSelectorByAuth } from '/@/api/permissionmgr/organize';
  ...
  function handleSync() {
    router.push('/systemmgr/sysConfig?type=1');
  }
