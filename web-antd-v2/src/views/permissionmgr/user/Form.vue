...
<script lang="ts" setup>
  import { createUser, updateUser, getUserInfo } from '/@/api/permissionmgr/user';
  import { getPositionByOrganize } from '/@/api/permissionmgr/position';
  import { getRoleByOrganize } from '/@/api/permissionmgr/role';
