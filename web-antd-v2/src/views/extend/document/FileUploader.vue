        ...
        <template #default="{ fileList }">
          <div class="file-panel">
            <div class="file-title">
              ...
              <div class="operate">
                <i class="icon-bts icon-bts-nav-close" @click="onComplete"></i>
              </div>
            </div>
            <div class="upload-file-list">
              ...
              <tsa-empty description="暂无待上传文件" v-if="!fileList.length" />
            </div>
          </div>
        </template>
      </uploader-list>
...
<script lang="ts" setup>
  ...
  import FileItem from '/@/components/Tsa/Upload/src/SimpleUploader/FileItem.vue';
  ...
  const options = reactive({
    target: globSetting.apiUrl + '/bot/filehandler/chunk',
