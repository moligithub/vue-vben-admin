<template>
  <BasicPopup v-bind="$attrs" @register="registerPopup" title="项目任务" class="full-popup" :destroy-on-close="true">
    <BasicTable :columns="columns" @register="registerTable" class="tsa-task-table tsa-sub-table">
      <template #toolbar>
      ...
      <template #bodyCell="{ column, record }">
        <template v-if="column.key === 'signColor'">
          <i class="icon-bts icon-bts-extend-star" :style="'color:' + record.signColor + '!important;'" v-if="record.signColor"></i>
          <i class="icon-bts icon-bts-extend-star-o i-default" v-else></i>
        </template>
