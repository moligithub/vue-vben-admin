<template>
  <div class="tsa-content-wrapper documentPreview-wrapper">
    <div class="tsa-content-wrapper-center">
      ...
      <div class="tsa-content-wrapper-content bg-white">
        ...
        <div class="p-10px">
          ...
          <a-alert message="免责声明：永中文档预览组件不属于BST产品，只用于介绍第三方组件如何在《BST快速开发平台》中使用。" type="warning" show-icon v-else />
        </div>
...
<style lang="less" scoped>
  .documentPreview-wrapper {
    &.tsa-content-wrapper .tsa-content-wrapper-center .tsa-content-wrapper-content {
      .tsa-content-wrapper-tabs.ant-tabs-card {
        height: auto;
      }
    }
  }
