        ...
        <BasicTable @register="registerTable">
          <template #toolbar>
            <a-tooltip placement="top">
              ...
              <i class="icon-bts icon-bts-generator-slider cursor-pointer text-18px" @click="openDrawer(true)"></i>
            </a-tooltip>
          </template>
          <template #tableTitle>
            <a-dropdown>
              ...
              <a-button type="primary" preIcon="icon-bts icon-bts-btn-add">{{ t('common.addText') }}<DownOutlined /></a-button>
            </a-dropdown>
            <tsa-upload-btn url="/bot/lowcodedev/Integrate/Actions/Import" accept=".bi" @on-success="reload"></tsa-upload-btn>
          </template>
...
<script lang="ts" setup>
  import { getIntegrateList, delIntegrate, copy, exportData, updateState } from '/@/api/lowcodedev/integrate';
