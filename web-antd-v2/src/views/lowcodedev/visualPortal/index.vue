      ...
      <div class="tsa-content-wrapper-content">
        <BasicTable @register="registerTable">
          <template #tableTitle>
            ...
            <tsa-upload-btn url="/bot/lowcodedev/Portal/Actions/Import" accept=".vp" @on-success="reload"></tsa-upload-btn>
          </template>
...
<script lang="ts" setup>
  ...
  import { getPortalList, delPortal, copyPortal, exportPortal } from '/@/api/lowcodedev/portal';
