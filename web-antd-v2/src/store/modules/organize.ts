...
import { getDepartmentSelector } from '/@/api/permissionmgr/organize';
import { getPositionListAll, getPositionSelector } from '/@/api/permissionmgr/position';
import { getGroupSelector } from '/@/api/permissionmgr/group';
import { getRoleSelector } from '/@/api/permissionmgr/role';
