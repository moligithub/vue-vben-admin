  ...
  <Dropdown placement="bottom" :overlayClassName="`${prefixCls}-dropdown-overlay`">
    ...
    <template #overlay>
      <Menu @click="handleMenuClick">
        <MenuItem key="profile" :text="t('layout.header.profile')" icon="icon-bts icon-bts-header-userInfo" />
        <MenuItem key="feedBack" :text="t('layout.header.feedback')" icon="icon-bts icon-bts-header-feedBack" />
        <MenuItem key="about" :text="t('layout.header.about')" icon="icon-bts icon-bts-header-about" />
        <MenuItem key="statement" :text="t('layout.header.statement')" icon="icon-bts icon-bts-generator-card" />
        <MenuItem key="lock" :text="t('layout.header.tooltipLock')" icon="icon-bts icon-bts-header-lockScreen" v-if="getUseLockPage" />
        <MenuDivider />
        <MenuItem key="logout" :text="t('layout.header.dropdownItemLoginOut')" icon="icon-bts icon-bts-header-loginOut" />
      </Menu>
    </template>
  </Dropdown>
