...
<script lang="ts" setup>
  import { getPositionByCondition } from '/@/api/permissionmgr/position';
  import { getSelectedList } from '/@/api/permissionmgr/user';
  ...
  defineOptions({ name: 'TsaPosSelect', inheritAttrs: false });
