<template>
  <div class="upload-file-container" :class="$attrs.class">
    <template v-if="!detailed">
      <a-button preIcon="icon-bts icon-bts-btn-upload" :disabled="disabled" @click="uploadFile">{{ buttonText }}</a-button>
...
<script lang="ts" setup>
  ...
  defineOptions({ name: 'TsaUploadFile', inheritAttrs: false });
