      ...
      <div class="tsa-content-wrapper-content">
        <BasicTable @register="registerTable">
          <template #tableTitle>
            ...
            <tsa-upload-btn :url="getUploadUrl" accept=".bdb" @on-success="reload"></tsa-upload-btn>
            <a-button type="link" preIcon="icon-bts icon-bts-btn-common" @click="handleFieldManage()">常用字段</a-button>
          </template>
...
<script lang="ts" setup>
  ...
  const getUploadUrl = computed(() => `/bot/systemmgr/DataModel/${unref(linkId)}/Actions/Import`);
