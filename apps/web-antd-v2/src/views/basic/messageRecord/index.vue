<template>
  <div class="tsa-content-wrapper message-record-wrapper">
    <div class="tsa-content-wrapper-center">
      ...
      <div class="tsa-content-wrapper-content bg-white">
        <a-tabs v-model:activeKey="activeKey" type="card" class="tsa-content-wrapper-tabs" destroyInactiveTabPane>
        ...
        <BasicTable @register="registerTable" :columns="columns" :searchInfo="getSearchInfo">
          <template #tableTitle>
            <a-button type="error" preIcon="icon-bts icon-bts-btn-clearn" @click="handleDelete">{{ t('common.delText') }}</a-button>
          </template>
...
<script lang="ts" setup>
  ...
  import { getMessageList, readInfo, delMsgRecord } from '/@/api/systemmgr/message';
