        ...
        <a-row>
          ...
          <a-col :span="12">
            <a-form-item label="性别">
              <tsa-select v-model:value="form2.gender" :options="genderOptions" placeholder="请选择" :fieldNames="{ value: 'enCode' }" showSearch />
            </a-form-item>
          </a-col>
          <a-col :span="12">
            <a-form-item label="民族">
              <tsa-select v-model:value="form2.nation" :options="nationOptions" placeholder="请选择" showSearch />
            </a-form-item>
          </a-col>
          <a-col :span="12">
          ...
          <a-col :span="12">
            <a-form-item label="证件类型">
              <tsa-select v-model:value="form2.certificatesType" :options="certificatesTypeOptions" placeholder="请选择" showSearch />
            </a-form-item>
          </a-col>
          <a-col :span="12">
          ...
          <a-col :span="12">
            <a-form-item label="文化程度">
              <tsa-select v-model:value="form2.education" :options="educationOptions" placeholder="请选择" showSearch />
            </a-form-item>
          </a-col>
          <a-col :span="12">
            <a-form-item label="出生年月">
              <tsa-date-picker v-model:value="form2.birthday" placeholder="请选择" format="YYYY-MM-DD" />
            </a-form-item>
          </a-col>
          <a-col :span="12">
          ...
          <a-col :span="24">
            <a-form-item label="自我介绍">
              <tsa-textarea v-model:value="form2.signature" :maxlength="300" placeholder="请输入" />
            </a-form-item>
          </a-col>
          <a-col :span="24">
            <a-form-item label=" ">
        ...
        <a-col :span="6" class="sign-item add-sign">
          <div class="sign-item-main">
            <a-dropdown trigger="click">
              <i class="add-icon icon-bts icon-bts-btn-add" @click.prevent></i>
              <template #overlay>
                <a-menu>
...
<script setup lang="ts">
  import { updateUserInfo, getSignList, deleteSign, updateDefaultSign, createSign } from '/@/api/permissionmgr/userSetting';
  ...
  import SignModal from '/@/components/Tsa/Sign/src/SignModal.vue';
  import { CheckOutlined } from '@ant-design/icons-vue';
  import { getBase64WithFile } from '/@/components/Tsa/Upload/src/helper';
