<template>
  <BasicModal v-bind="$attrs" @register="registerModal" title="发布" @ok="handleSubmit" class="tsa-release-modal">
            ...
            <div class="release-item">
              <a-form-item>
                <div class="top-item" :class="{ active: dataForm.pcPortal === 1 }" @click="selectToggle('pcPortal')">
                  <i class="item-icon icon-bts icon-bts-pc"></i>
              ...
              <a-form-item label="应用" name="pcPortalSystemId" v-if="dataForm.pcPortal">
                <TsaSelect v-model:value="dataForm.pcPortalSystemId" :options="treeData" multiple allowClear />
              </a-form-item>
            ...
            <div class="release-item">
              <a-form-item>
                <div class="top-item" :class="{ active: dataForm.appPortal === 1 }" @click="selectToggle('appPortal')">
                  <i class="item-icon icon-bts icon-bts-mobile"></i>
              ...
              <a-form-item label="应用" name="appPortalSystemId" v-if="dataForm.appPortal">
                <TsaSelect v-model:value="dataForm.appPortalSystemId" :options="treeAppData" multiple allowClear />
              </a-form-item>
...
<script lang="ts" setup>
  import { release, getSystemListFilter } from '/@/api/lowcodedev/portal';
  import { BasicModal, useModalInner } from '/@/components/Modal';
  import { ref, reactive, toRefs, nextTick, computed } from 'vue';
  import type { FormInstance } from 'ant-design-vue';
  import { CheckOutlined } from '@ant-design/icons-vue';
  import { getMenuSelectorFilter } from '/@/api/systemmgr/menu';
