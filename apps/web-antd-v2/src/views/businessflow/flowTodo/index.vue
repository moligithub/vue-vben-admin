    ...
    <div class="tsa-content-wrapper-center">
      <div class="tsa-content-wrapper-content">
        <BasicTable @register="registerTable">
          <template #tableTitle>
            <a-button type="primary" preIcon="icon-bts icon-bts-btn-batch" @click="openBatchList(true, {})">批量审批</a-button>
          </template>
...
<script lang="ts" setup>
  ...
  import { getFlowBeforeList } from '/@/api/businessflow/flowBefore';
