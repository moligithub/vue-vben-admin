...
<script lang="ts" setup>
  import {
    ...
    getBatchCandidate,
    batchOperation,
  } from '/@/api/businessflow/flowBefore';
  ...
  import ApprovalModal from '/@/views/businessflow/components/modal/ApprovalModal.vue';
  import ActionModal from '/@/views/businessflow/components/modal/ActionModal.vue';
  import ErrorModal from '/@/views/businessflow/components/modal/ErrorModal.vue';
