<template>
  <BasicModal v-bind="$attrs" @register="registerModal" title="选择商品" @ok="handleSubmit" :width="800" class="tsa-list-modal">
    <BasicTable @register="registerTable" class="tsa-sub-table"></BasicTable>
  </BasicModal>
</template>
