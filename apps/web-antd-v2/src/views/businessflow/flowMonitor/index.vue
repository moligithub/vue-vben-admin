    ...
    <div class="tsa-content-wrapper-center">
      <div class="tsa-content-wrapper-content">
        <BasicTable @register="registerTable">
          <template #tableTitle>
            <a-button type="error" preIcon="icon-bts icon-bts-delete" @click="handleDelete">{{ t('common.delText') }}</a-button>
          </template>
...
<script lang="ts" setup>
  ...
  import { getFlowMonitorList, delMonitorList } from '/@/api/businessflow/flowMonitor';
