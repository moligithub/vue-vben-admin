<template>
  <BasicModal v-bind="$attrs" @register="registerModal" :title="t('common.addText')" :footer="null" :width="600" class="tsa-add-modal">
    <div class="add-main">
      <div class="add-item add-item-left" @click="add(0, 2)">
        <i class="add-icon icon-bts icon-bts-launchFlow"></i>
        <div class="add-txt">
      ...
      <div class="add-item" @click="add(0, 1)">
        <i class="add-icon icon-bts icon-bts-funcFlow"></i>
        <div class="add-txt">
