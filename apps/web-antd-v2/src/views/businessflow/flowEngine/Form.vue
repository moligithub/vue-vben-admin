        ...
        <BasicForm @register="registerForm">
          <template #icon="{ model, field }">
            <a-row type="flex">
              ...
              <a-form-item-rest>
                <tsa-color-picker v-model:value="iconBackground" size="small" :predefine="predefineList" name="iconBackground" />
              </a-form-item-rest>
            </a-row>
          </template>
        </BasicForm>
...
<script lang="ts" setup>
  import { getInfo, create, update, setMainVersion } from '/@/api/businessflow/flowEngine';
