...
<script lang="ts" setup>
  ...
  import { templateDownload, importPreview, importData, exportExceptionData } from '/@/api/permissionmgr/user';
  ...
  const getAction = computed(() => globSetting.apiUrl + '/bot/permissionmgr/Users/Uploader');
