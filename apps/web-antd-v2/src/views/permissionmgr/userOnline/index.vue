    ...
    <div class="tsa-content-wrapper-center">
      <div class="tsa-content-wrapper-content">
        <BasicTable @register="registerTable">
          <template #tableTitle>
            <a-button type="error" preIcon="icon-bts icon-bts-delete" @click="batchDelete">强制下线</a-button>
          </template>
...
<script lang="ts" setup>
  import { getOnlineUser, batchDelOnlineUser, deleteOnlineUser } from '/@/api/permissionmgr/onlineUser';
