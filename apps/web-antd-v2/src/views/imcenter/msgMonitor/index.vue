    ...
    <div class="tsa-content-wrapper-center">
      <div class="tsa-content-wrapper-content">
        <BasicTable @register="registerTable">
          <template #tableTitle>
            <a-button type="error" preIcon="icon-bts icon-bts-btn-clearn" @click="handleDel">{{ t('common.delText') }}</a-button>
...
<script lang="ts" setup>
  ...
  import { getMsgMonitorList, delMsgMonitor, emptyMsgMonitor } from '/@/api/imcenter/msgMonitor';
