    ...
    <BasicTable @register="registerTable" :data-source="testSendData">
      <template #bodyCell="{ column, record }">
        ...
        <template v-if="column.key === 'toUser'">
          <TsaUserSelect v-model:value="record.toUser" multiple placeholder="请选择" v-if="record.messageType != 'webhook'" />
        </template>
...
<script lang="ts" setup>
  ...
  import { getTestSendConfig, testSendConfig } from '/@/api/imcenter/sendConfig';
