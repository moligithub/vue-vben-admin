<template>
  <div class="common-container">
    ...
    <a-modal v-model:visible="visible" title="选择门户" :width="800" class="tsa-list-modal" @ok="handleSubmit" @cancel="handleCancel">
      <template #closeIcon>
      ...
      <div class="tsa-content-wrapper">
        <div class="tsa-content-wrapper-center">
          <div class="tsa-content-wrapper-content">
            <BasicTable @register="registerTable" :searchInfo="searchInfo" class="tsa-sub-table"></BasicTable>
          </div>
        </div>
      </div>
    </a-modal>
...
<script lang="ts" setup>
  ...
  import { getPortalManageSelector } from '/@/api/lowcodedev/portal';
