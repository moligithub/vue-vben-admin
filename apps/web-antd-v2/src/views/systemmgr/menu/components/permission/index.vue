<template>
  <BasicPopup v-bind="$attrs" @register="registerPopup" :title="title" class="full-popup">
    ...
    <div class="no-data" v-else>
      <tsa-empty :description="description" />
    </div>
  </BasicPopup>
</template>
<script lang="ts" setup>
  import { getMenuPermissionGroup, getMenuPermissionInfo } from '/@/api/systemmgr/menu';
  import { getPermissionGroup, getPermissionInfo } from '/@/api/permissionmgr/permissionGroup';
