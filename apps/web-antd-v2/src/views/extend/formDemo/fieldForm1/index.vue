<template>
  <div class="tsa-content-wrapper tsa-content-wrapper-form">
    <div class="tsa-content-wrapper-form-body px-10px">
      <ScrollContainer>
        <div class="my-10px">
        ...
        <a-form ref="formRef" :colon="false" :model="dataForm" :labelCol="{ style: { width: '110px' } }">
          ...
          <a-form-item label="生产日期">
            <tsa-date-picker v-model:value="dataForm.ProductionDate" format="YYYY-MM-DD" allowClear />
          </a-form-item>
          <a-form-item label="回款日期">
            <tsa-date-picker v-model:value="dataForm.ReturnMoneyDate" format="YYYY-MM-DD HH:mm:ss" allowClear />
          </a-form-item>
          <a-form-item label="计划执行日期">
            <tsa-date-picker v-model:value="dataForm.PlanExecutionDate" format="YYYY-MM-DD HH:mm:ss" allowClear />
          </a-form-item>
          <a-form-item label="统计月份">
            <tsa-date-picker v-model:value="dataForm.StatisticalMonth" format="YYYY-MM" allowClear />
          </a-form-item>
          <a-form-item label="规划日期">
            <tsa-date-picker v-model:value="dataForm.Programme" format="YYYY-MM-DD" allowClear />
          </a-form-item>
          <a-form-item label="规划日期">
            <tsa-date-range v-model:value="dataForm.Dates" format="YYYY-MM-DD HH:mm:ss" allowClear />
          </a-form-item>
        </a-form>
      </ScrollContainer>
    </div>
