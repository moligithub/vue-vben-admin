<template>
  <div class="tsa-content-wrapper h-full">
    <div class="tsa-content-wrapper-center">
      <div class="sale-order-content">
        <BasicTable @register="registerTable" @row-click="handleRowClick">
          <template #tableTitle>
            <a-button type="primary" preIcon="icon-bts icon-bts-btn-add" @click="handleAdd()">{{ t('common.addText') }}</a-button>
            <a-button type="link" preIcon="icon-bts icon-bts-btn-edit" @click="handleUpdate()">{{ t('common.editText') }}</a-button>
            <a-button type="link" preIcon="icon-bts icon-bts-delete" @click="handleDel()">{{ t('common.delText') }}</a-button>
