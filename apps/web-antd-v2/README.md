...
| ------------------------ | ------ | ------------- | ---------------------- |
| **后端**(任一后端服务)   |        |               |                        |
| tsa-java-boot           | v3.6.x | v3.6.x-stable | Java 单体工程      |
| tsa-java-cloud          | v3.6.x | v3.6.x-stable | Java 微服务工程    |
| **前端**                 |        |               |                        |
| tsa-web-datascreen      | v3.6.x | v3.6.x-stable | 大屏前端工程 |
...
# 网站标题
VITE_GLOB_APP_TITLE = BST快速开发平台

# 简称，用于配置文件名字 不要出现空格、数字开头等特殊字符
VITE_GLOB_APP_SHORT_NAME = bst
```
